app.controller('smsPendingCtrl', function ($controller, $scope, blockUI, coreService, toaster, $ngBootbox, uuid, $timeout, DTOptionsBuilder, DTColumnBuilder, $compile, $filter) {
    ...
    vm.dtColumns = [
        ...
        DTColumnBuilder.newColumn('Subject').withTitle('Tiêu đề').withClass('text-nowrap')
            .withOption('defaultContent', ''),
        DTColumnBuilder.newColumn('Phone').withTitle('Gửi đến').withClass('text-nowrap')
            .withOption('defaultContent', ''),
