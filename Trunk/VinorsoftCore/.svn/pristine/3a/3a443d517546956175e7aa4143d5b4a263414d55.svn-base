        ...
        (function (Wizard) {
                ...
                ConfigureQueryPage.prototype.runQueryBuilder = function () {
                    ...
                    this._dataSource().dbSchemaProvider.getDbSchema().done(function (dbSchema) {
                        ...
                        if (query && query.type() === Data.Utils.SqlQueryType.tableQuery) {
                            query.name(_this.queryName());
                            _this.popupQueryBuilder.show(query, _this._dataSource());
                        }
                        else {
                            _this.popupQueryBuilder.show(new Data.TableQuery({ "@Name": _this.queryName() }, _this._dataSource()), _this._dataSource());
                        }
                    });
                };
            ...
            var FullscreenDataSourceWizard = (function (_super) {
                ...
                FullscreenDataSourceWizard.prototype.canRunWizard = function () {
                    return this._dataSourceWizardOptions.jsonDataSourceAvailable || this._dataSourceWizardOptions.sqlDataSourceAvailable || this._dataSourceWizardOptions.objectDataSourceAvailable;
                };
